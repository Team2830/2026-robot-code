...
public class AbsoluteDriveAdv extends Command
{
  ...
  public void execute()
  {
    ...
    translation = SwerveMath.limitVelocity(translation, swerve.getFieldVelocity(), swerve.getPose(),
                                           SwerveSubsystem.LOOP_TIME, SwerveSubsystem.ROBOT_MASS, List.of(SwerveSubsystem.CHASSIS),
    ...
    {
      resetHeading = true;
      swerve.drive(translation, (SwerveSubsystem.TURN_CONSTANT * -headingAdjust.getAsDouble()), true);
    } else
    {
